...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_WORKERREPORTINREQUEST']._serialized_end = 112
    _globals['_REGISTERRESPONSE']._serialized_start = 114
    _globals['_REGISTERRESPONSE']._serialized_end = 150
    _globals['_UPDATEPROVIDERREQUEST']._serialized_start = 152
    _globals['_UPDATEPROVIDERREQUEST']._serialized_end = 250
    _globals['_SUPERVISOR']._serialized_start = 253
    _globals['_SUPERVISOR']._serialized_end = 443
